...
function submitHandler(e) {
    ...
    for(let val = 1; val <= promiceAmountField.value; val++){
        const anotherPromiseInTheWall = createPromise(val, currentTimer).then(({ position , delay  })=>{
            Notify.success({
                width: "350px",
...
},{"./x-notify":"6sU1C"}],"6sU1C":[function(require,module,exports) {
